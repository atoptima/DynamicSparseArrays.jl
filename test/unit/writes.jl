function test_insert()
    ...
    @test_call DynamicSparseArrays.insert!(array, 4, 10, nothing)
    ...
    @test_call DynamicSparseArrays.insert!(array, 1, 10, nothing)
    ...
    @test_call DynamicSparseArrays.insert!(array, 2, 11, nothing)
    ...
    @test_call DynamicSparseArrays.insert!(array, 8, 10, nothing)
    ...
    @test_call DynamicSparseArrays.insert!(array, 1, 10, 3, 6, nothing)
    ...
    @test_call DynamicSparseArrays.insert!(array, 1, 11, 3, 6, nothing)
    ...
    @test_call DynamicSparseArrays.insert!(array, 4, 10, 3, 6, nothing)
...
function test_delete()
    ...
    @test_call DynamicSparseArrays.delete!(array, 2)
    ...
    @test_call DynamicSparseArrays.purge!(array, 3, 5)
